...
const SingleClass = ({classData,saveSelectedClass,checkStudent}) => {
    ...
    return (
        <div className={`card ${seats>0?'bg-base-100':'bg-red-600'} shadow-xl`}>
            ...
            <div className="card-body">
                ...
                <p><strong>Instructor Name: </strong> {instructorName}</p>
                    ...
                    <button disabled={!checkStudent || seats==0} onClick={()=>saveSelectedClass(classData)} className="btn btn-warning btn-block">Select Class</button>
